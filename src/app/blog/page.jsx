...
export const metadata = {
  ...
  alternates: {
    canonical: "https://iluma-store.ru/blog",
  },
  openGraph: {
    ...
    url: "https://iluma-store.ru/blog",
    type: "website",
    siteName: "IQOS Iluma | Блог",
    locale: "ru_RU",
    images: [
      {
        url: "https://iluma-store.ru/images/blog-og-image.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://iluma-store.ru/images/blog-twitter-card.jpg"],
  },
  robots: {
    index: true,
    follow: true,
