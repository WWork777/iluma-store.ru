...
const CheckoutPage = () => {
  ...
  // Функция для отправки в Telegram (закомментирована)
  /*
...
Общая сумма: ${totalPrice} ₽
        ...
        // Сохранение в базу данных (закомментировано)
        /*
        ...
        */
        ...
        // Отправка WhatsApp (закомментирована)
        /*
...
${selectedMethod === "delivery" ? `🏙 Город: ${formData.city || "Не указан"}` : ""}`;
        ...
        */
        ...
        // Запускаем только email отправку (остальные закомментированы)
